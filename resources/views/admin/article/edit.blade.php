...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4 pb-5">
        ...
        <div class="p-5" style="">
            <form action="{{url('/admin/articles/'.$article->slug.'/update')}}" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title"
                           value="{{old('title')? old('title') : (isset($article->title) ? $article->title : '') }}"
                           class="form-control" id="title" placeholder="عنوان">
                </div>
                <div class="form-group">
                    <label for="short_description">شرح کوتاه</label>
                    <input type="text" name="short_description"
                           value="{{old('short_description') ? old('short_description') : (isset($article->short_description) ? $article->short_description : '')}} "
                           class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="author"
                           value="{{old('author') ? old('author') : (isset($article->author) ? $article->author : '')}} "
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="source"
                           value="{{old('source') ? old('source') : (isset($article->source) ? $article->source : '')}}"
                ...
                <div class="form-group">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <img id="showImage" src="{{asset('image/articles/small/'.$article->image)}}"
                        ...
                        @if($categories !== null)
                            ...
                            @foreach($categories as $cat)
                                <option @if(old('category_id') !== null && old('category_id') == $cat->id)  selected
                                        @elseif(isset($article) && $article->category_id === $cat->id) selected @endif
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tags"
                           class="form-control visually-hidden" data-role="tagsinput" value="{{$tags}}"/>
                </div>
